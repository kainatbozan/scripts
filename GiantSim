...
_G.AutoCrate = false
_G.SelectedCrateType = "skin, weapon" -- Varsayılan olarak kostüm seçili
_G.tpspeed = 0.4 
...
CratesTab:CreateDropdown({
   ...
   Callback = function(Option)
      ...
      if Option[1] == "Legendary Skin (100K)" then
          _G.SelectedCrateType = "skin"
      elseif Option[1] == "Legendary Weapon (100K)" then
...
Rayfield:Notify({
   Title = "Hibrid Sistem Yüklendi",
   Content = "Listeden kılıç veya kostüm seçip hemen açmaya başlayabilirsin.",
   Duration = 5,
   Image = 4483362458,
})
